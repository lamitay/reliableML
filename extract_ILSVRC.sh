...
#
mkdir E:/MLreliability_project/data/imagenet
#
# Extract the training data:
#
# Create train directory; move .tar file; change directory
#mkdir E:/MLreliability_project/data/imagenet/test && mv ILSVRC2010_images_test.tar E:/MLreliability_project/data/imagenet/test/ && cd E:/MLreliability_project/data/imagenet/test
# Extract training set; remove compressed file
#tar -xvf ILSVRC2010_images_test.tar
#
...
cd E:/MLreliability_project/data
#
...
#  && rm -f ILSVRC2012_img_val.tar  # from the last
