...
def main():
    ...
    base_exp_dir = 'C:/Users/David/PycharmProjects/reliableML/experiments_David'
    val_dir = 'E:/MLreliability_project/data/imagenet-r'
    ...
    val_dataset = ImageFolder(val_dir, transform=preprocess_images_imagenet_r())
    ...
    with torch.no_grad():
        for images, labels in tqdm(val_loader, desc=f"Processing {exp_name}"):
            ...
            probabilities = probabilities * torch.tensor(imagenet_r_mask)  # using only the classes that are in both datasets
